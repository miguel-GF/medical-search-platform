  ...
  <div>
    ...
    <main id="contenido">
      ...
      <section id="puebla" class="section container puebla-grid">
        <div class="puebla-art" aria-hidden="true"><svg viewBox="0 0 500 350" fill="none"><path d="M-20 70 520 210M-10 150 490 290M90-20 200 380M220-20 320 380M360-20 440 350M-20 300 510 50" stroke="currentColor" stroke-width="22"/><path d="M80 180 220 220 300 123 400 148" stroke="#0f766e" stroke-width="3" stroke-dasharray="6 8"/><circle cx="80" cy="180" r="11" fill="#0f766e"/><circle cx="400" cy="148" r="11" fill="#0f766e"/></svg><div class="map-label"><BrandMark /><strong>Puebla<small>Aquí comienza Pruevia</small></strong></div><span class="map-note">Una ciudad. Muchas posibilidades.</span></div>
