...
const cards = computed(() => dashboard.value ? [
  { label: 'Catálogo activo', value: dashboard.value.active_catalog_items, helper: 'servicios canónicos', icon: 'offers', tone: 'teal' },
  { label: 'Ofertas activas', value: dashboard.value.active_offers, helper: 'servicios publicados', icon: 'providers', tone: 'blue' },
  { label: 'Por revisar', value: dashboard.value.normalization_ambiguous, helper: 'con candidatos', icon: 'review', tone: dashboard.value.normalization_ambiguous ? 'amber' : 'green', action: 'ambiguous' },
  { label: 'Sin cobertura', value: dashboard.value.normalization_no_match, helper: 'faltan en el catálogo', icon: 'records', tone: dashboard.value.normalization_no_match ? 'amber' : 'green', action: 'no_match' },
  { label: 'Alertas abiertas', value: dashboard.value.open_alerts, helper: 'seguimiento operativo', icon: 'alerts', tone: dashboard.value.open_alerts ? 'amber' : 'green', action: 'alerts' },
  { label: 'Críticas', value: dashboard.value.critical_alerts, helper: dashboard.value.critical_alerts ? 'atención inmediata' : 'todo en orden', icon: 'quality', tone: dashboard.value.critical_alerts ? 'red' : 'green', action: 'alerts' },
] : []);
