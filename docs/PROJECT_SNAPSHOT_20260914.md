# Snapshot del README anterior

Archivado el 14-sep-2026. Contiene estados y cifras de varios cortes anteriores;
no representa una nueva verificación. Consulta [CURRENT_STATE](CURRENT_STATE.md)
y [la entrada vigente](../README.md). Las instrucciones del texto archivado son
antecedentes, no el procedimiento actual.
...
Consulta el detalle y los comandos reproducibles en [docs/03_REVISION_INTEGRACION.md](03_REVISION_INTEGRACION.md), [docs/02_FASES_IMPLEMENTACION.md](02_FASES_IMPLEMENTACION.md) y la evidencia del flujo de proveedor en [docs/PROVIDER_CLAIMS_EVIDENCE_20260831.md](PROVIDER_CLAIMS_EVIDENCE_20260831.md).
La auditoria de seguridad mas reciente y sus pruebas estan en [docs/SECURITY_AUDIT_20260901.md](SECURITY_AUDIT_20260901.md).

## Estado actual

- Arquitectura de producto y software: definida.
- Base de datos V1: migraciones 001-138 aplicadas y verificadas; las migraciones 128-138 agregan segmentacion exacta de paquetes, la cola administrativa de revision, la validacion de proveedor en el flujo de alias, limites de captura publica, mutaciones idempotentes y endurecimiento de seguridad de la evidencia.
...
- Flutter Patient MVP: búsqueda, receta multi-estudio, OCR con revisión, comparación por sucursal, PWA responsive, Android/iOS preparados, consentimiento y telemetría anónima limitada. `Acceso para proveedores` es una entrada secundaria; todas las operaciones de proveedor (lecturas y mutaciones) exigen MFA `aal2` en el backend.
...
[docs/COBERTURA_REAL_20260831.md](COBERTURA_REAL_20260831.md).
...
[docs/REAL_QUERY_RESEARCH_V1.md](REAL_QUERY_RESEARCH_V1.md).
...
Comienza por el [índice de documentación](README.md). El Data Engine permanece en Gate A positivo y el siguiente corte de producto será conectar el flujo de autenticación/MFA del proveedor y validar la PWA con usuarios externos.
