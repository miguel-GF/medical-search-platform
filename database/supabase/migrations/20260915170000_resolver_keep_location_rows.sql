-- Preserve one row per offer, concrete location and price.  Provider offers
-- may legitimately share an id across branches; deduplicating without the
-- location id hides verified branches from the patient resolver.
