-- Keep one current exact LOINC mapping per canonical item when a code exists
-- in more than one reviewed release. Different canonical items remain
-- ambiguous and are intentionally returned as separate candidates.
