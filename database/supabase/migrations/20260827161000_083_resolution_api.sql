-- Public resolution API. The existing /search contract remains available and
-- now benefits from catalog.search_items hardening; this endpoint exposes
-- ambiguity and explanations explicitly.
